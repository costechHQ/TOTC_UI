...
const Hero = () => {
  return (
    <section className="relative w-full overflow-hidden lg:h-[calc(100vh-40px)] lg:px-32 bg-[#49BBBD] pb-16 lg:pb-0">

      <div className="mx-auto flex h-full max-w-7xl flex-col items-center justify-center px-5 py-8 sm:px-8 md:py-10 lg:flex-row lg:gap-6 lg:py-0">
...
<div className="relative flex w-full flex-1 items-center justify-center ">
  <div className="relative w-full max-w-95 xl:max-w-105">
            ...
            <Image
              ...
              height={300}
              priority
              className="absolute left-3.75 top-[25%] z-30 hidden w-full lg:block"
            />
            ...
            <Image
              ...
              className="absolute left-1/2 top-[8%] z-30
               w-[75%] max-w-75 -translate-x-1/2 md:hidden"
            />
