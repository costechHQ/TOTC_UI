...
// 1. ADD THE MISSING SUB-COMPONENTS HERE:
const SectionTitle = ({ children }: { children: React.ReactNode }) => (
  <h2 className="text-center text-2xl font-bold text-[#2F327D] md:text-3xl">{children}</h2>
);

const SectionSubtitle = ({ children }: { children: React.ReactNode }) => (
  <p className="mx-auto mt-4 max-w-2xl text-center text-sm text-[#696984]">{children}</p>
);
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:mt-14 lg:grid-cols-3">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm md:p-8">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#F4EEFB]">
          ...
          {/* Card 2 */}
          <div className="rounded-2xl bg-white p-6 shadow-sm md:p-8">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#E6F7F8]">
          ...
          {/* Card 3 */}
          {/* FIXED: Added bg-[#EBF1FF] to the icon container below */}
          <div className="rounded-2xl bg-white p-6 shadow-sm sm:col-span-2 lg:col-span-1 md:p-8">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#EBF1FF]">
